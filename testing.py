...
def makeTestWindow(testFiles:list[str]):
    ...
    def inputWord(event):
        nonlocal totalMemoryCount, newMemoryCount, gettingWord, wordKeys, wordIndex, wrongWords, passing
